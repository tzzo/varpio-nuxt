    ...
    article.product
      .left
        ...
        ul 
          ...
          li Loraus sitruunanmehua
          li 0,5 dl ranskankermaa
          li Ripaus ruususuolaa
          li (Mustapippuria)
        span.recipe-title Valmistusohjeet:
        ol
          li Pilko lehtikaali hieman pienemmäksi.
      ...
      .right
        img(src="~assets/img/recipes/lehtikaalipesto.jpg")
</template>
